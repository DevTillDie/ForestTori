...
extension DataManager {
    private func setupChapterData() {
        ...
        let emptyPlant = Plant(characterName: "???",
                               characterImage: "PlantSelect_Spring2",
                               characterDescription: "추후 공개 예정",
                               mainQuest: "????",
                               missions: [],
                               totalDay: 7)
        ...
        let spring = Chapter(chapterId: 1, chapterTitle: "봄, 숲을 만나다",
                             ...
                             lastChapterEnding: "",
                             chapterPlants: [dandelion, emptyPlant, emptyPlant, emptyPlant, emptyPlant])
